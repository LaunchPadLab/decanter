...
This adds `#decant_new`, `#decant_create`, `#decant_create!`, `#decant_update`, `#decant_update!`, and `#decant` to your model, allowing you to use the gem in the existing style.
